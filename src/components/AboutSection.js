      ...
      <div className="about-card">
        ...
        <div className="about-content">
          ...
          <p className="about-description">
            ...
            renovation, and maintenance for residential, commercial, and industrial projects.
          </p>
          <p className="about-description">
            Our focus is on quality workmanship and customer satisfaction, delivering reliable,
            efficient electrical services and ensuring the safety and functionality of your systems.
          </p>
